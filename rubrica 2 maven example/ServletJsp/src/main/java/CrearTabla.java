...
public class CrearTabla {
     ...
     * @param args
     */
    public static void consultas(String[] args)
    {
        try
        {
            Class.forName("org.h2.Driver");
            Connection con = DriverManager.getConnection("jdbc:h2:~/home/osboxes/Escritorio/DDI/ServletJsp/src/main/resources/test", "sa", "" );
